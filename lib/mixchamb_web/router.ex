defmodule MixchambWeb.Router do
  use MixchambWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {MixchambWeb.Layouts, :root}
  ...
  scope "/", MixchambWeb do
    ...
    live_session :default,
      on_mount: [
        {MixchambWeb.UserAuth, :current_user},
        {MixchambWeb.UserAuth, :maybe_admin},
        {MixchambWeb.Live.BannerHook, :default}
      ] do
      live "/", LandingLive
      ...
      # on retro_sessions. Under /archives/ so future archived
  ...
  scope "/admin", MixchambWeb.Admin, as: :admin do
    pipe_through :admin

    live_session :admin,
      on_mount: [
        {MixchambWeb.UserAuth, :current_user},
        {MixchambWeb.UserAuth, :current_admin},
        {MixchambWeb.Live.BannerHook, :default}
      ] do
